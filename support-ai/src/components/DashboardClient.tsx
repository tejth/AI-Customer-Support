...
function DashboardClient({ ownerId }: { ownerId: string }) {
  ...
  return (
    <div className="min-h-screen ng-zinc-50 text-zinc-900 ">
      <motion.div
        initial={{ y: -50 }}
        animate={{ y: 0 }}
      ...
      <div className="flex justify-center px-4 py-14 mt-20">
        <motion.div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-10">
          ...
          <div className="mb-10">
            ...
            <div className="space-y-4">
              <textarea
                ...
                • Delivery time: 355 working days
                • Cash on Delivery available
                • Support hours `}
                className="h-54 w-full rounded-xl border border-zinc-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-black/80"
          ...
          <div className="flex items-center gap-5">
            ...
            {saved && (
              <motion.span className="text-sm font-medium text-emerald-600">
                ✔️ Settings Saved!
              </motion.span>
            )}
          </div>
